import{d,_ as u,y as h,b as a,e as t,x as s,A as r,F as f,Z as g,o as n,$ as v,l as x,g as b}from"../modules/vue-BLSydUt3.js";import{u as y,h as N,c as m,b as k}from"../index-BUdPamP1.js";import{N as w}from"./NoteDisplay-m3gjzXxn.js";import"../modules/shiki-CLbx7ow3.js";const D={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},z={class:"opacity-50"},A=t("div",{class:"flex-auto"},null,-1),C={key:0,class:"border-main mb-8"},F=d({__name:"print",setup(M){const{slides:p,total:_}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
